...
},{"../object/keys":22,"./baseCopy":5}],5:[function(require,module,exports){
...
},{"../utility/identity":27}],8:[function(require,module,exports){
...
},{"./bindCallback":7,"./isIterateeCall":11}],9:[function(require,module,exports){
var htmlEscapes = {
        '&': '&amp;',
        '<': '&lt;',
        '>': '&gt;',
...
},{"../lang/isObject":19,"./isIndex":10,"./isLength":12}],12:[function(require,module,exports){
var MAX_SAFE_INTEGER = Math.pow(2, 53) - 1;
...
},{"../lang/isArguments":16,"../lang/isArray":17,"../object/keysIn":23,"../support":26,"./isIndex":10,"./isLength":12}],16:[function(require,module,exports){
...
},{"../internal/isObjectLike":13,"../string/escapeRegExp":25}],19:[function(require,module,exports){
...
},{"../internal/baseAssign":4,"../internal/createAssigner":8}],21:[function(require,module,exports){
...
},{"../internal/arrayCopy":2,"../internal/assignDefaults":3,"./assign":20}],22:[function(require,module,exports){
...
module.exports = keys;
},{"../internal/isLength":12,"../internal/shimKeys":15,"../lang/isNative":18,"../lang/isObject":19}],23:[function(require,module,exports){
...
},{"../internal/isIndex":10,"../internal/isLength":12,"../lang/isArguments":16,"../lang/isArray":17,"../lang/isObject":19,"../support":26}],24:[function(require,module,exports){
...
},{"../internal/baseToString":6,"../internal/escapeHtmlChar":9}],25:[function(require,module,exports){
...
},{"./internal/root":14,"./lang/isNative":18}],27:[function(require,module,exports){
function identity(value) {
    return value;
}
module.exports = identity;
},{}],28:[function(require,module,exports){
var buildCommandPatch = require('./api/command-patch'), buildCommand = require('./api/command'), buildSelection = require('./api/selection'), buildSimpleCommand = require('./api/simple-command');
'use strict';
...
},{"./api/command":30,"./api/command-patch":29,"./api/selection":31,"./api/simple-command":32}],29:[function(require,module,exports){
'use strict';
...
},{"lodash-amd/modern/object/defaults":21}],34:[function(require,module,exports){
...
module.exports = blockElementNames;
...
module.exports = inlineElementNames;
},{"immutable":1}],36:[function(require,module,exports){
var nodeHelpers = require('./node'), mutations = require('./mutations');
...
},{"./mutations":38,"./node":39}],37:[function(require,module,exports){
var Immutable = require('immutable');
'use strict';
...
},{"immutable":1}],38:[function(require,module,exports){
...
module.exports = { determineMutationObserver: determineMutationObserver };
},{}],39:[function(require,module,exports){
var inlineElementNames = require('./constants/inline-element-names'), blockElementNames = require('./constants/block-element-names'), Immutable = require('immutable');
'use strict';
...
},{"./constants/block-element-names":34,"./constants/inline-element-names":35,"immutable":1}],40:[function(require,module,exports){
...
},{"./commands/indent":41,"./commands/insert-list":42,"./commands/outdent":43,"./commands/redo":44,"./commands/subscript":45,"./commands/superscript":46,"./commands/undo":47}],41:[function(require,module,exports){
'use strict';
...
},{"immutable":1}],43:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
...
var observeDomChanges = require('../../dom-observer'), Immutable = require('immutable');
'use strict';
module.exports = function () {
    return function (scribe) {
        var nodeHelpers = scribe.node;
...
},{"../../dom-observer":36,"immutable":1}],49:[function(require,module,exports){
...
},{"./formatters/html/replace-nbsp-chars":52,"./formatters/plain-text/escape-html-characters":53}],50:[function(require,module,exports){
var Immutable = require('immutable');
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"immutable":1}],51:[function(require,module,exports){
var nodeHelpers = require('../../../../node'), Immutable = require('immutable');
'use strict';
...
},{"../../../../node":39,"immutable":1}],52:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"lodash-amd/modern/string/escape":24}],54:[function(require,module,exports){
'use strict';
...
},{"./patches/commands/bold":56,"./patches/commands/create-link":57,"./patches/commands/indent":58,"./patches/commands/insert-html":59,"./patches/commands/insert-list":60,"./patches/commands/outdent":61,"./patches/events":62}],56:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"./formatters/html/enforce-p-elements":50,"./formatters/html/ensure-selectable-containers":51,"./inline-elements-mode":54,"./set-root-p-element":64}],64:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
        if (scribe.getHTML().trim() === '') {
...
},{"lodash-amd/modern/object/assign":20}],66:[function(require,module,exports){
var Immutable = require('immutable');
'use strict';
...
},{"./api":28,"./config":33,"./event-emitter":37,"./node":39,"./plugins/core/commands":40,"./plugins/core/events":48,"./plugins/core/formatters":49,"./plugins/core/patches":55,"./plugins/core/plugins":63,"./transaction-manager":65,"./undo-manager":66,"immutable":1}]},{},[67])(67)
});