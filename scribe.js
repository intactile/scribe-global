...
module.exports = function (baseCopy, keys) {
    ...
    return baseAssign;
}(require('./baseCopy'), require('../object/keys'));
},{"../object/keys":19,"./baseCopy":3}],3:[function(require,module,exports){
...
},{"../utility/identity":24}],6:[function(require,module,exports){
...
}(require('./bindCallback'), require('./isIterateeCall'));
},{"./bindCallback":5,"./isIterateeCall":9}],7:[function(require,module,exports){
module.exports = function () {
    var htmlEscapes = {
        '&': '&amp;',
        '<': '&lt;',
...
}(require('./isIndex'), require('./isLength'), require('../lang/isObject'));
...
module.exports = function (isArguments, isArray, isIndex, isLength, keysIn, support) {
    ...
    return shimKeys;
}(require('../lang/isArguments'), require('../lang/isArray'), require('./isIndex'), require('./isLength'), require('../object/keysIn'), require('../support'));
},{"../lang/isArguments":14,"../lang/isArray":15,"../object/keysIn":20,"../support":23,"./isIndex":8,"./isLength":10}],14:[function(require,module,exports){
module.exports = function (isLength, isObjectLike) {
    ...
    return isArguments;
}(require('../internal/isLength'), require('../internal/isObjectLike'));
...
module.exports = function (isLength, isNative, isObjectLike) {
    ...
    return isArray;
}(require('../internal/isLength'), require('./isNative'), require('../internal/isObjectLike'));
...
module.exports = function (escapeRegExp, isObjectLike) {
    ...
    return isNative;
}(require('../string/escapeRegExp'), require('../internal/isObjectLike'));
},{"../internal/isObjectLike":11,"../string/escapeRegExp":22}],17:[function(require,module,exports){
module.exports = function () {
...
module.exports = function (baseAssign, createAssigner) {
    ...
    return assign;
}(require('../internal/baseAssign'), require('../internal/createAssigner'));
},{"../internal/baseAssign":2,"../internal/createAssigner":6}],19:[function(require,module,exports){
module.exports = function (isLength, isNative, isObject, shimKeys) {
    ...
    return keys;
}(require('../internal/isLength'), require('../lang/isNative'), require('../lang/isObject'), require('../internal/shimKeys'));
},{"../internal/isLength":10,"../internal/shimKeys":13,"../lang/isNative":16,"../lang/isObject":17}],20:[function(require,module,exports){
module.exports = function (isArguments, isArray, isIndex, isLength, isObject, support) {
    ...
    return keysIn;
}(require('../lang/isArguments'), require('../lang/isArray'), require('../internal/isIndex'), require('../internal/isLength'), require('../lang/isObject'), require('../support'));
},{"../internal/isIndex":8,"../internal/isLength":10,"../lang/isArguments":14,"../lang/isArray":15,"../lang/isObject":17,"../support":23}],21:[function(require,module,exports){
module.exports = function (baseToString, escapeHtmlChar) {
    ...
    return escape;
}(require('../internal/baseToString'), require('../internal/escapeHtmlChar'));
},{"../internal/baseToString":4,"../internal/escapeHtmlChar":7}],22:[function(require,module,exports){
module.exports = function (baseToString) {
    ...
    return escapeRegExp;
}(require('../internal/baseToString'));
},{"../internal/baseToString":4}],23:[function(require,module,exports){
module.exports = function (isNative, root) {
    ...
    return support;
}(require('./lang/isNative'), require('./internal/root'));
},{"./internal/root":12,"./lang/isNative":16}],24:[function(require,module,exports){
module.exports = function () {
...
}(require('./api/command-patch'), require('./api/command'), require('./api/selection'), require('./api/simple-command'));
},{"./api/command":27,"./api/command-patch":26,"./api/selection":28,"./api/simple-command":29}],26:[function(require,module,exports){
module.exports = function () {
    'use strict';
...
},{"immutable":1}],31:[function(require,module,exports){
module.exports = function (Immutable) {
...
},{"immutable":1}],32:[function(require,module,exports){
module.exports = function (Immutable) {
...
},{"immutable":1}],33:[function(require,module,exports){
...
}(require('./node'), require('./mutations'));
},{"./mutations":36,"./node":37}],34:[function(require,module,exports){
module.exports = function (Immutable) {
    'use strict';
...
},{"immutable":1}],35:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return {
...
}(require('./constants/inline-element-names'), require('./constants/block-element-names'), require('immutable'));
},{"./constants/block-element-names":31,"./constants/inline-element-names":32,"immutable":1}],38:[function(require,module,exports){
...
}(require('./commands/indent'), require('./commands/insert-list'), require('./commands/outdent'), require('./commands/redo'), require('./commands/subscript'), require('./commands/superscript'), require('./commands/undo'));
},{"./commands/indent":39,"./commands/insert-list":40,"./commands/outdent":41,"./commands/redo":42,"./commands/subscript":43,"./commands/superscript":44,"./commands/undo":45}],39:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"immutable":1}],41:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
}(require('../../dom-observer'), require('immutable'));
},{"../../dom-observer":33,"immutable":1}],47:[function(require,module,exports){
...
}(require('./formatters/html/replace-nbsp-chars'), require('./formatters/plain-text/escape-html-characters'));
},{"./formatters/html/replace-nbsp-chars":50,"./formatters/plain-text/escape-html-characters":51}],48:[function(require,module,exports){
module.exports = function (Immutable) {
    'use strict';
    return function () {
        return function (scribe) {
            ...
            function wrapChildNodes(parentNode) {
                var index = 0;
                Immutable.List(parentNode.childNodes).filterNot(function (node) {
...
},{"immutable":1}],49:[function(require,module,exports){
...
}(require('../../../../node'), require('immutable'));
},{"../../../../node":37,"immutable":1}],50:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
}(require('lodash-amd/modern/string/escape'));
},{"lodash-amd/modern/string/escape":21}],52:[function(require,module,exports){
module.exports = function (nodeHelpers) {
    'use strict';
...
},{"../../node":37}],53:[function(require,module,exports){
...
}(require('./patches/commands/bold'), require('./patches/commands/indent'), require('./patches/commands/insert-html'), require('./patches/commands/insert-list'), require('./patches/commands/outdent'), require('./patches/commands/create-link'), require('./patches/events'));
},{"./patches/commands/bold":54,"./patches/commands/create-link":55,"./patches/commands/indent":56,"./patches/commands/insert-html":57,"./patches/commands/insert-list":58,"./patches/commands/outdent":59,"./patches/events":60}],54:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
}(require('./set-root-p-element'), require('./formatters/html/enforce-p-elements'), require('./formatters/html/ensure-selectable-containers'), require('./inline-elements-mode'));
},{"./formatters/html/enforce-p-elements":48,"./formatters/html/ensure-selectable-containers":49,"./inline-elements-mode":52,"./set-root-p-element":62}],62:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
module.exports = function (assign, events) {
    'use strict';
    return function (scribe) {
...
}(require('lodash-amd/modern/object/assign'), require('./events'));
},{"./events":35,"lodash-amd/modern/object/assign":18}],64:[function(require,module,exports){
module.exports = function (Immutable) {
    'use strict';
...
},{"immutable":1}],65:[function(require,module,exports){
module.exports = function (plugins, commands, formatters, events, patches, Api, buildTransactionManager, UndoManager, EventEmitter, nodeHelpers, Immutable, config, eventNames) {
    'use strict';
    ...
    return Scribe;
}(require('./plugins/core/plugins'), require('./plugins/core/commands'), require('./plugins/core/formatters'), require('./plugins/core/events'), require('./plugins/core/patches'), require('./api'), require('./transaction-manager'), require('./undo-manager'), require('./event-emitter'), require('./node'), require('immutable'), require('./config'), require('./events'));
},{"./api":25,"./config":30,"./event-emitter":34,"./events":35,"./node":37,"./plugins/core/commands":38,"./plugins/core/events":46,"./plugins/core/formatters":47,"./plugins/core/patches":53,"./plugins/core/plugins":61,"./transaction-manager":63,"./undo-manager":64,"immutable":1}]},{},[65])(65)
});