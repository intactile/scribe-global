...
},{"./mutations":35,"./node":36}],34:[function(require,module,exports){
module.exports = function (Immutable) {
    'use strict';
...
},{"./constants/block-element-names":31,"./constants/inline-element-names":32,"immutable":1}],37:[function(require,module,exports){
...
},{"./commands/indent":38,"./commands/insert-list":39,"./commands/outdent":40,"./commands/redo":41,"./commands/subscript":42,"./commands/superscript":43,"./commands/undo":44}],38:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"immutable":1}],40:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"../../dom-observer":33,"immutable":1}],46:[function(require,module,exports){
...
},{"./formatters/html/replace-nbsp-chars":49,"./formatters/plain-text/escape-html-characters":50}],47:[function(require,module,exports){
module.exports = function (Immutable) {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"immutable":1}],48:[function(require,module,exports){
...
},{"../../../../node":36,"immutable":1}],49:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"lodash-amd/modern/string/escape":21}],51:[function(require,module,exports){
...
},{"../../node":36}],52:[function(require,module,exports){
...
},{"./patches/commands/bold":53,"./patches/commands/create-link":54,"./patches/commands/indent":55,"./patches/commands/insert-html":56,"./patches/commands/insert-list":57,"./patches/commands/outdent":58,"./patches/events":59}],53:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"./formatters/html/enforce-p-elements":47,"./formatters/html/ensure-selectable-containers":48,"./inline-elements-mode":51,"./set-root-p-element":61}],61:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
}(require('lodash-amd/modern/object/assign'));
},{"lodash-amd/modern/object/assign":18}],63:[function(require,module,exports){
module.exports = function (Immutable) {
    'use strict';
...
},{"immutable":1}],64:[function(require,module,exports){
module.exports = function (plugins, commands, formatters, events, patches, Api, buildTransactionManager, UndoManager, EventEmitter, nodeHelpers, Immutable, config) {
    ...
    return Scribe;
}(require('./plugins/core/plugins'), require('./plugins/core/commands'), require('./plugins/core/formatters'), require('./plugins/core/events'), require('./plugins/core/patches'), require('./api'), require('./transaction-manager'), require('./undo-manager'), require('./event-emitter'), require('./node'), require('immutable'), require('./config'));
},{"./api":25,"./config":30,"./event-emitter":34,"./node":36,"./plugins/core/commands":37,"./plugins/core/events":45,"./plugins/core/formatters":46,"./plugins/core/patches":52,"./plugins/core/plugins":60,"./transaction-manager":62,"./undo-manager":63,"immutable":1}]},{},[64])(64)
});