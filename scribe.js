...
module.exports = pull;
},{"../internal/baseIndexOf":9}],3:[function(require,module,exports){
var includes = require('./includes');
module.exports = includes;
},{"./includes":4}],4:[function(require,module,exports){
...
module.exports = includes;
},{"../internal/baseIndexOf":9,"../internal/isLength":18,"../lang/isArray":23,"../lang/isString":26,"../object/values":31}],5:[function(require,module,exports){
...
},{"../object/keys":29,"./baseCopy":8}],8:[function(require,module,exports){
...
},{"./indexOfNaN":15}],10:[function(require,module,exports){
...
},{"./bindCallback":12,"./isIterateeCall":17}],14:[function(require,module,exports){
var htmlEscapes = {
        '&': '&amp;',
        '<': '&lt;',
        '>': '&gt;',
...
},{"../lang/isObject":25,"./isIndex":16,"./isLength":18}],18:[function(require,module,exports){
var MAX_SAFE_INTEGER = Math.pow(2, 53) - 1;
...
},{"../lang/isArguments":22,"../lang/isArray":23,"../object/keysIn":30,"../support":34,"./isIndex":16,"./isLength":18}],22:[function(require,module,exports){
...
},{"../internal/isLength":18,"../internal/isObjectLike":19}],23:[function(require,module,exports){
...
},{"../internal/isLength":18,"../internal/isObjectLike":19,"./isNative":24}],24:[function(require,module,exports){
...
},{"../internal/isObjectLike":19,"../string/escapeRegExp":33}],25:[function(require,module,exports){
...
},{"../internal/isObjectLike":19}],27:[function(require,module,exports){
var baseAssign = require('../internal/baseAssign'), createAssigner = require('../internal/createAssigner');
var assign = createAssigner(baseAssign);
module.exports = assign;
},{"../internal/baseAssign":7,"../internal/createAssigner":13}],28:[function(require,module,exports){
...
},{"../internal/arrayCopy":5,"../internal/assignDefaults":6,"./assign":27}],29:[function(require,module,exports){
...
module.exports = keys;
},{"../internal/isLength":18,"../internal/shimKeys":21,"../lang/isNative":24,"../lang/isObject":25}],30:[function(require,module,exports){
...
},{"../internal/isIndex":16,"../internal/isLength":18,"../lang/isArguments":22,"../lang/isArray":23,"../lang/isObject":25,"../support":34}],31:[function(require,module,exports){
var baseValues = require('../internal/baseValues'), keys = require('./keys');
function values(object) {
    return baseValues(object, keys(object));
}
module.exports = values;
},{"../internal/baseValues":11,"./keys":29}],32:[function(require,module,exports){
...
},{"../internal/baseToString":10,"../internal/escapeHtmlChar":14}],33:[function(require,module,exports){
...
},{"../internal/baseToString":10}],34:[function(require,module,exports){
...
},{"./internal/root":20,"./lang/isNative":24}],35:[function(require,module,exports){
...
},{"./api/command":39,"./api/command-patch":38,"./api/node":40,"./api/selection":41,"./api/simple-command":42}],37:[function(require,module,exports){
'use strict';
...
module.exports = function (scribe) {
    ...
    Selection.prototype.getContaining = function (nodeFilter) {
        ...
        return !(node.node && scribe.el === node.node) && nodeFilter(node.node) ? node.node : node.getAncestor(scribe.el, nodeFilter);
    };
...
},{"lodash-amd/modern/object/defaults":28}],44:[function(require,module,exports){
var elementHelpers = require('./element'), nodeHelpers = require('./node');
function observeDomChanges(el, callback) {
    function includeRealMutations(mutations) {
        var realChangedNodes = mutations.map(function (mutation) {
                return mutations.slice.call(mutation.addedNodes).concat(mutations.slice.call(mutation.removedNodes));
            }).reduce(function (result, input) {
                return result.concat(input);
            }, []).filter(function (n) {
                return !nodeHelpers.isEmptyTextNode(n) && !elementHelpers.isSelectionMarkerNode(n);
            });
...
},{"./element":45,"./node":47}],45:[function(require,module,exports){
...
},{"lodash-amd/modern/collection/contains":3}],46:[function(require,module,exports){
...
},{"immutable/dist/immutable":1,"lodash-amd/modern/array/pull":2}],47:[function(require,module,exports){
'use strict';
...
},{"./commands/indent":49,"./commands/insert-list":50,"./commands/outdent":51,"./commands/redo":52,"./commands/subscript":53,"./commands/superscript":54,"./commands/undo":55}],49:[function(require,module,exports){
'use strict';
...
},{"../../api/children":37,"../../dom-observer":44,"lodash-amd/modern/collection/contains":3}],57:[function(require,module,exports){
...
},{"./formatters/html/replace-nbsp-chars":60,"./formatters/plain-text/escape-html-characters":61}],58:[function(require,module,exports){
...
},{"immutable/dist/immutable":1}],59:[function(require,module,exports){
...
},{"../../../../element":45,"lodash-amd/modern/collection/contains":3}],60:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"lodash-amd/modern/string/escape":32}],62:[function(require,module,exports){
'use strict';
...
},{"./patches/commands/bold":64,"./patches/commands/create-link":65,"./patches/commands/indent":66,"./patches/commands/insert-html":67,"./patches/commands/insert-list":68,"./patches/commands/outdent":69,"./patches/events":70}],64:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"./formatters/html/enforce-p-elements":58,"./formatters/html/ensure-selectable-containers":59,"./inline-elements-mode":62,"./set-root-p-element":72}],72:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
        if (scribe.getHTML().trim() === '') {
...
},{"lodash-amd/modern/object/assign":27}],74:[function(require,module,exports){
'use strict';
...
},{"./api":36,"./config":43,"./element":45,"./event-emitter":46,"./node":47,"./plugins/core/commands":48,"./plugins/core/events":56,"./plugins/core/formatters":57,"./plugins/core/patches":63,"./plugins/core/plugins":71,"./transaction-manager":73,"./undo-manager":74,"immutable/dist/immutable":1}]},{},[75])(75)
});