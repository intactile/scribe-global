...
},{"./api/command":4,"./api/command-patch":3,"./api/selection":5,"./api/simple-command":6}],3:[function(require,module,exports){
...
},{"immutable":1}],9:[function(require,module,exports){
module.exports = function (Immutable) {
...
},{"./mutations":14,"./node":15}],11:[function(require,module,exports){
module.exports = function (Immutable) {
    'use strict';
...
},{"immutable":1}],12:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return {
...
},{"./constants/block-element-names":8,"./constants/inline-element-names":9,"immutable":1}],16:[function(require,module,exports){
...
},{"./commands/indent":17,"./commands/insert-list":18,"./commands/outdent":19,"./commands/redo":20,"./commands/subscript":21,"./commands/superscript":22,"./commands/undo":23}],17:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
module.exports = function (keystrokes) {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"../../../keystrokes":13}],21:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"../../../keystrokes":13}],24:[function(require,module,exports){
...
},{"../../dom-observer":10,"immutable":1}],25:[function(require,module,exports){
...
},{"./formatters/html/replace-nbsp-chars":28,"./formatters/plain-text/escape-html-characters":29}],26:[function(require,module,exports){
module.exports = function (Immutable) {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"immutable":1}],27:[function(require,module,exports){
    ...
    function traverse(parentNode) {
        ...
        while (node) {
            if (!nodeHelpers.isSelectionMarkerNode(node)) {
                if (isEmpty(node) && node.textContent.trim() === '' && !html5VoidElements.includes(node.nodeName) && node.nodeName.indexOf('-') === -1) {
...
},{"../../../../node":15,"immutable":1}],28:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"./patches/commands/bold":32,"./patches/commands/create-link":33,"./patches/commands/indent":34,"./patches/commands/insert-html":35,"./patches/commands/insert-list":36,"./patches/commands/outdent":37,"./patches/events":38}],32:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"./formatters/html/enforce-p-elements":26,"./formatters/html/ensure-selectable-containers":27,"./inline-elements-mode":30,"./set-root-p-element":40}],40:[function(require,module,exports){
module.exports = function () {
    'use strict';
    return function () {
        return function (scribe) {
...
},{"./api":2,"./config":7,"./event-emitter":11,"./events":12,"./node":15,"./plugins/core/commands":16,"./plugins/core/events":24,"./plugins/core/formatters":25,"./plugins/core/patches":31,"./plugins/core/plugins":39,"./transaction-manager":41,"./undo-manager":42,"immutable":1}]},{},[43])(43)
});