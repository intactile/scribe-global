...
},{"./api/command":31,"./api/command-patch":30,"./api/node":32,"./api/selection":33,"./api/simple-command":34}],29:[function(require,module,exports){
'use strict';
...
},{"lodash-amd/modern/object/defaults":21}],36:[function(require,module,exports){
...
},{"./element":37,"./node":39}],37:[function(require,module,exports){
...
},{"immutable":1}],39:[function(require,module,exports){
'use strict';
...
var observeDomChanges = require('../../dom-observer'), children = require('../../api/children');
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"../../api/children":29,"../../dom-observer":36}],49:[function(require,module,exports){
...
var element = require('../../../../element'), Immutable = require('immutable');
'use strict';
...
},{"../../../../element":37,"immutable":1}],52:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"./api":28,"./config":35,"./element":37,"./event-emitter":38,"./node":39,"./plugins/core/commands":40,"./plugins/core/events":48,"./plugins/core/formatters":49,"./plugins/core/patches":55,"./plugins/core/plugins":63,"./transaction-manager":65,"./undo-manager":66,"immutable":1}]},{},[67])(67)
});