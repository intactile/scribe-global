...
},{"./formatters/html/replace-nbsp-chars":69,"./formatters/plain-text/escape-html-characters":70}],67:[function(require,module,exports){
...
},{"lodash-amd/modern/arrays/last":3}],68:[function(require,module,exports){
...
},{"../../../../element":54,"lodash-amd/modern/collections/contains":5}],69:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"lodash-amd/modern/utilities/escape":42}],71:[function(require,module,exports){
'use strict';
...
},{"./patches/commands/bold":73,"./patches/commands/create-link":74,"./patches/commands/indent":75,"./patches/commands/insert-html":76,"./patches/commands/insert-list":77,"./patches/commands/outdent":78,"./patches/events":79}],73:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
...
},{"./formatters/html/enforce-p-elements":67,"./formatters/html/ensure-selectable-containers":68,"./inline-elements-mode":71,"./set-root-p-element":81}],81:[function(require,module,exports){
'use strict';
module.exports = function () {
    return function (scribe) {
        if (scribe.getHTML().trim() === '') {
...
},{"lodash-amd/modern/objects/assign":30}],83:[function(require,module,exports){
'use strict';
...
},{"./api":46,"./config":52,"./element":54,"./event-emitter":55,"./node":56,"./plugins/core/commands":57,"./plugins/core/events":65,"./plugins/core/formatters":66,"./plugins/core/patches":72,"./plugins/core/plugins":80,"./transaction-manager":82,"./undo-manager":83,"immutable/dist/immutable":1}]},{},[84])(84)
});